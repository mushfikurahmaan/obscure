          ...
          {notes.map(note => (
            <ContextMenu key={note.id}>
              <ContextMenuTrigger asChild>
                <div
                  className="relative flex flex-col gap-2 px-5 py-4 rounded-2xl bg-white dark:bg-[hsl(var(--card))] border border-[hsl(var(--border))] shadow-md hover:shadow-xl transition-all cursor-pointer select-none group min-h-[120px]"
